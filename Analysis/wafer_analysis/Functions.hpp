...
TID_Data TRDAC_VCD_CALLINE_THDAC(Data data)
  {
    TID_Data TID;
    TID.timeStamp = data.timeStamp;
    TID.MRad = data.MRad;
...
TID_Data Functions(TString graphName, TString padName, TString fileName, Data data, int function)
{
  ...
  switch(function)
    ...
    case 2: TID = TRDAC_VCD_CALLINE_THDAC(data); break;
    case 3: TID = Ref_R8B(data); break;
    case 4: TID = Ref_R8B(data); break;
    case 5: TID = Ref_R8B(data); break;
    case 6: TID = TRDAC_VCD_CALLINE_THDAC(data); break;
    case 7: TID = TRDAC_VCD_CALLINE_THDAC(data); break;
